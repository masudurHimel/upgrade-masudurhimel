...
3. **If the topic is NEW (not in the roadmap):**
   ...
   b. **You MUST add it to that path's `ROADMAP.md` + `PROGRESS.md` in the right month/cluster and manage the roadmap accordingly** (update counts/bars, checklist entry).
