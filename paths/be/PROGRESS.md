...
> **Created:** 2026-08-22 · **Checkpoint:** ~2026-10-24 · **Last updated:** 2026-09-05 (learning day 10)
...
```
BE1 Client → request     [███░░░░░░░░░░░░░░░░░]  14%   (1/7 topics · BE1.1 [✓] · BE1.2 [~] 2/5 cards)
...
Artifacts (written)  0/3        Tests passed   0        Teach-back ✓   1 topic + 1 partial (7 cards)
```

**Next up:** BE1.2 card 3 — TTL mechanics & trade-offs. Open bucket: 2026-09-02 (BE1.2 cards 3–5). Next session (day 11) is a learning day; day 12 = review.
...
| 2026-09-02 | BE1.2 DNS resolution | ~~(2) caching at every layer — cleared 2026-09-05~~ · (3) TTL mechanics & trade-offs · (4) record types + failure modes (NXDOMAIN vs SERVFAIL vs timeout) · (5) edge cases + staff lens (negative caching, K8s `ndots`) | **OPEN** |
...
- [~] BE1.2 DNS resolution — recursive lookup, caching, TTL *(cards 1–2/5 ✓ — recursive lookup chain 2026-09-02 · caching at every layer 2026-09-05; cards 3–5 in bucket)*
