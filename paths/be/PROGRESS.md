...
> **Created:** 2026-08-22 · **Checkpoint:** ~2026-10-24 · **Last updated:** 2026-09-20 (learning day 14)
...
**Next up:** 🔁 **Day-15 REVIEW** — next session IS the review day. Must resurface: (1) *TTL expiry as the self-recovery mechanism* (missed day 10 AND day 12 — needs one clean unprompted pass); (2) *stale cache ⇒ old-IP success, never NXDOMAIN* — a cache stores answers; other-name success only proves the resolver is alive (flagged day 13). No open buckets — all clear. After the review: BE1.3 TCP connection setup (3-way handshake).
